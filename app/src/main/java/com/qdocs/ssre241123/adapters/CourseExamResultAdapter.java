...
public class CourseExamResultAdapter extends RecyclerView.Adapter<CourseExamResultAdapter.MyViewHolder> {
    ...
    public CourseExamResultAdapter(FragmentActivity studentonlineexam, ArrayList<String> questionlist,
                                   ...
                                   ArrayList<String> marklist, ArrayList<String> getmarklist, ArrayList<String> neg_marks_list,
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_onlinecourse_exam_result, parent, false);
