    ...
    public void onBindViewHolder(CourseLessonAdapter.MyViewHolder holder, final int position) {
     ...
     //   holder.nameTV.setText( model.getLessonTitle());
        if(model.getType().equals("lesson")){
            ...
            holder.imageview.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_assignment));
            holder.headingTV.setText(context.getApplicationContext().getString(R.string.assignment)+": ");
            holder.nameTV.setText(model.getAssignment_title());
        }else if(model.getType().equals("exam")){
            holder.imageview.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.ic_online_exams));
            holder.headingTV.setText(context.getApplicationContext().getString(R.string.exams)+": ");
            holder.nameTV.setText(model.getCourse_exam_name());
        }
