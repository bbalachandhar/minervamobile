...
import com.qdocs.ssre241123.adapters.StudentClassTimetableAdapter;
...
public class StudentClassTimetable extends BaseActivity {
    ...
    RecyclerView List1, List2, List3, List4, List5, List6, List7;
    ...
    LinearLayout NoData1,NoData2,NoData3,NoData4,NoData5,NoData6,NoData7;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List1 = findViewById(R.id.classTimetable_mondayList);
        List2 = findViewById(R.id.classTimetable_tuesdayList);
        List3 = findViewById(R.id.classTimetable_wednesdayList);
        List4 = findViewById(R.id.classTimetable_thursdayList);
        List5 = findViewById(R.id.classTimetable_fridayList);
        List6 = findViewById(R.id.classTimetable_saturdayList);
        List7 = findViewById(R.id.classTimetable_sundayList);
        ...
        NoData1 = findViewById(R.id.mondayNoData);
        NoData2 = findViewById(R.id.tuesdayNoData);
        NoData3 = findViewById(R.id.wednesdayNoData);
        NoData4 = findViewById(R.id.thursdayNoData);
        NoData5 = findViewById(R.id.fridayNoData);
        NoData6 = findViewById(R.id.saturdayNoData);
        NoData7 = findViewById(R.id.sundayNoData);
        ...
        List4.setLayoutManager(LayoutManager4);
        List4.setItemAnimator(new DefaultItemAnimator());
        List4.setAdapter(Adapter4);

        List5.setLayoutManager(LayoutManager5);
        List5.setItemAnimator(new DefaultItemAnimator());
        List5.setAdapter(Adapter5);


        List6.setLayoutManager(LayoutManager6);
        List6.setItemAnimator(new DefaultItemAnimator());
        List6.setAdapter(Adapter6);


        List7.setLayoutManager(LayoutManager7);
        List7.setItemAnimator(new DefaultItemAnimator());
                ...
                if (result != null) {
                    ...
                    try {
                        ...
                        if (success.equals("200")) {
                            ...
                            Log.e("mondayArray", String.valueOf(mondayArray.length()));
                            Log.e("tuesdayArray",String.valueOf(tuesdayArray.length()));
                            Log.e("wednesdayArray", String.valueOf(wednesdayArray.length()));
                            Log.e("thursdayArray", String.valueOf(thursdayArray.length()));
                            Log.e("fridayArray",  String.valueOf(fridayArray.length()));
                            Log.e("saturdayArray", String.valueOf(saturdayArray.length()));
                            Log.e("sundayArray",  String.valueOf(sundayArray.length()));
