...
import com.qdocs.ssre241123.adapters.StudentQuestionsListAdapter;
...
public class OnlineCourseExam extends AppCompatActivity {
    private static final int REQUEST_PERMISSIONS = 100;
    String extension="",filename="";
    Bitmap selectedImageString = null;
    private static final String TAG = "StudentOnlineExamQuestionsNew";
    String Online_exam_id,durationList,onlineexam_student_idlist,course_exam_name,is_neg_markingList;
   ...
   File f;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.online_course_exam_layout);
        course_exam_name = getIntent().getExtras().getString("course_exam_name");
        Online_exam_id = getIntent().getExtras().getString("course_exam_id");
        durationList = getIntent().getExtras().getString("duration");
        onlineexam_student_idlist = Utility.getSharedPreferences(getApplicationContext(), Constants.studentId);
        ...
        new CountDownTimer(millis, 1000) {
            ...
            public void onFinish() {
                ...
                for(int i=0;i<dlist.length();i++){
                    try {
                        String stationCode = dlist.getJSONObject(i).getString("question_id");
                ...
                try {
                    result_param.put("student_id", onlineexam_student_idlist);
                    result_param.put("guest_id", "0");
                    result_param.put("exam_id", Online_exam_id);
                    result_param.put("usertype", Utility.getSharedPreferences(getApplicationContext(), Constants.loginType));
        ...
        buttonSelectImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    Log.e("Else", "Else");
                    ActivityCompat.requestPermissions(OnlineCourseExam.this, permissions(), 1);
                    showFileChooser();
        ...
        moption1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (buttonView.isChecked() ) {
                    ...
                    try {
                        jsonObject.put("student_id", onlineexam_student_idlist);
            ...
            public void onClick(View view) {
                try {
                    ...
                    if(dataArray.getJSONObject(position-1).getString("question_type").equals("descriptive")){
                        ...
                        try {
                            attachments.put("attachment",filelist);
                            System.out.println("at the time of attachment==" + attachments.toString());
                ...
                new AlertDialog.Builder(OnlineCourseExam.this)
                        ...
                        .setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                if(Utility.isConnectingToInternet(getApplicationContext())){
                                    try {
                                        if (attachments != null) {
                                            System.out.println("what is this json array or string=="+attachments.getClass().getSimpleName());
                                        } else {
            ...
            public void onClick(View view) {
                ...
                if(dataArray.length() != 0) {
                    ...
                    try {
                        ...
                        //question_idList.add(dataArray.getJSONObject(hold-1).getString("id"));
                        onlineexam_idList.add(dataArray.getJSONObject(hold-1).getString("online_course_exam_id"));
                        ...
                        if(dataObject.getString("is_marks_display").equals("1")){
                            ...
                            marks.setText("(Marks:"+dataArray.getJSONObject(hold-1).getString("onlineexam_question_marks")+")");
                        }else{
                        ...
                        question_id=dataArray.getJSONObject(hold-1).getString("exam_question_marks_id");
                        ...
                        try {
                            ...
                            if(Integer.valueOf(question) == (serial)) {
                                ...
                                if(dataArray.getJSONObject(hold).getString("question_type").equals("descriptive")){
                                    ...
                                    Toast.makeText(OnlineCourseExam.this, "not in any", Toast.LENGTH_SHORT).show();
                                }
                            }else{
            ...
            public void onClick(View v) {
                ...
                if(dataArray.length() != 0) {
                    ...
                    try {
                       ...
                       // question_idList.add(dataArray.getJSONObject(position).getString("id"));
                        if(dataObject.getString("is_marks_display").equals("1")){
                            marks.setVisibility(View.VISIBLE);
                            marks.setText("(Marks:"+dataArray.getJSONObject(position).getString("onlineexam_question_marks")+")");
                        }else{
                            marks.setVisibility(View.GONE);
                        }
                        ...
                        onlineexam_idList.add(dataArray.getJSONObject(position).getString("online_course_exam_id"));
                        ...
                        question_id=dataArray.getJSONObject(position).getString("exam_question_marks_id");
    ...
    private void showFileChooser() {
        final Dialog dialog = new Dialog(OnlineCourseExam.this);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            filePath = getgalleryRealPathFromURI(OnlineCourseExam.this, uri);
            ...
            if (bitmap != null) {
                progress = new ProgressDialog(OnlineCourseExam.this);
    ...
    public  void  loaddata(){
        if(Utility.isConnectingToInternet(getApplicationContext())) {
            ...
            params.put("exam_id", Online_exam_id);
    ...
    private void submitExam(JSONObject attachments) throws IOException {
        final String url = Utility.getSharedPreferences(getApplicationContext(), "apiUrl") + Constants.saveOnlineCourseExamUrl;
        OkHttpClient client=new OkHttpClient();
        System.out.println("url===="+url);

        MultipartBody.Builder multipartBody = new MultipartBody.Builder()
                .setType(MultipartBody.FORM)
                .addFormDataPart("student_id", onlineexam_student_idlist)
                .addFormDataPart("guest_id", "0")
                .addFormDataPart("usertype", Utility.getSharedPreferences(getApplicationContext(), Constants.loginType))
                .addFormDataPart("exam_id", Online_exam_id)
                .addFormDataPart("rows",String.valueOf(dlist));

        try {
            if (attachments != null) {
                JSONObject attach_obj = attachments;
                System.out.println("attach_obj=="+attach_obj);
                System.out.println("attach_obj=="+ attachments.toString());
            ...
            client.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(Call call, IOException e) {
                    runOnUiThread(new Runnable() {
                        public void run() {
                            final Toast toast = Toast.makeText(OnlineCourseExam.this, R.string.apiErrorMsg, Toast.LENGTH_SHORT);
                            toast.show();
                        }
                    });
                }
                        ...
                        try {
                            ...
                            try {
                                ...
                                if(Jarray.equals("1")){
                                    runOnUiThread(new Runnable(){
                                        public void run() {
                                            Toast.makeText(OnlineCourseExam.this, getApplicationContext().getString(R.string.submit_success), Toast.LENGTH_SHORT).show();
                                            finish();
                                        }
                                    });
                                }else{
                                    runOnUiThread(new Runnable(){
                                        public void run() {
                                            try {
                                                ...
                                                Toast.makeText(OnlineCourseExam.this, error.getString("file"), Toast.LENGTH_SHORT).show();
                                            } catch (JSONException e) {
                                                e.printStackTrace();
                                            }
                                        }
    ...
    private void getDataFromApi (String bodyParams) {
        ...
        String url = Utility.getSharedPreferences(getApplicationContext(), "apiUrl")+Constants.getOnlineCourseQuestionUrl;
        Log.e("URL", url);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String result) {
                ...
                if (result != null) {
                    ...
                    try {
                        ...
                        result_statusList.add("");
                        attempt_statusList.add("");
                        ...
                        if(dataArray.length()>1) {
                           ...
                           // question_idList.add(dataArray.getJSONObject(0).getString("id"));
                            ...
                            onlineexam_idList.add(dataArray.getJSONObject(0).getString("online_course_exam_id"));

                            if(dataObject.getString("is_marks_display").equals("1")){
                                marks.setVisibility(View.VISIBLE);
                                marks.setText("(Marks:"+dataArray.getJSONObject(0).getString("onlineexam_question_marks")+")");
                            }else{
                                marks.setVisibility(View.GONE);
                            }
                            ...
                            if(question_typeList.equals("singlechoice")){
                                singlechoice_layout.setVisibility(View.VISIBLE);
                                multiplechoice_layout.setVisibility(View.GONE);
                                descriptive_layout.setVisibility(View.GONE);
                                truefalse_layout.setVisibility(View.GONE);
                            ...
                            }else if(question_typeList.equals("multichoice")){
                                singlechoice_layout.setVisibility(View.GONE);
                                multiplechoice_layout.setVisibility(View.VISIBLE);
                                descriptive_layout.setVisibility(View.GONE);
                                truefalse_layout.setVisibility(View.GONE);
                            ...
                            }else if(question_typeList.equals("descriptive")){
                                singlechoice_layout.setVisibility(View.GONE);
                                multiplechoice_layout.setVisibility(View.GONE);
                                descriptive_layout.setVisibility(View.VISIBLE);
                                truefalse_layout.setVisibility(View.GONE);
                            }else if(question_typeList.equals("true_false")){
                                singlechoice_layout.setVisibility(View.GONE);
                                multiplechoice_layout.setVisibility(View.GONE);
                                descriptive_layout.setVisibility(View.GONE);
                                truefalse_layout.setVisibility(View.VISIBLE);
                            ...
                            question_id=dataArray.getJSONObject(0).getString("exam_question_marks_id");
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(OnlineCourseExam.this, R.string.apiErrorMsg, Toast.LENGTH_LONG).show();
            }
        }) {
            @Override
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(OnlineCourseExam.this); //Creating a Request Queue
