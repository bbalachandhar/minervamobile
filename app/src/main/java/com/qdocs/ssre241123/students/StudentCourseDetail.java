...
import com.qdocs.ssre241123.adapters.CourseCurriculumAdapterNew;
import com.qdocs.ssre241123.adapters.CourseReviewAdapterNew;
import com.qdocs.ssre241123.model.LessonModel;
import com.qdocs.ssre241123.model.SectionModel;
...
public class StudentCourseDetail  extends BaseActivity {
    ...
    WebView webView;
    LinearLayout price_layout,lesson_layout,quiz_layout,hour_layout,rating_layout,exam_layout,assignment_layout;
    public Map<String, String> headers = new HashMap<String, String>();
    public Map<String, String> params = new Hashtable<String, String>();
    TextView courseDescription,totalrating,courseLearnheading;
    TextView courseNameTV,teacherNameTV,teacherupdateDateTV,courselesson,coursequiz,courseexam,courseassignment,coursediscount,courseclass,courseprice,buy_now_btn,coursehours;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignment_layout=findViewById(R.id.assignment_layout);
        ...
        courseexam=findViewById(R.id.courseDetail_exam);
        courseassignment=findViewById(R.id.courseDetail_assignment);
                         ...
                         curriculum_layout.setVisibility(View.VISIBLE);
                            for (int j = 0; j < dataArray.length(); j++) {
                                ...
                                for (int i = 0; i < lessonArray.length(); i++) {
                                    ...
                                    model.setAssignment_title(lessonArray.getJSONObject(i).getString("assignment_title"));
                                    model.setCourse_exam_name(lessonArray.getJSONObject(i).getString("course_exam_name"));
                ...
                if (result != null) {
                    ...
                    try {
                     ...
                     //   makeText(StudentCourseDetail.this, dataArray.getString("updated_date"), Toast.LENGTH_SHORT).show();
                        ...
                        if(dataArray.getString("assignment_count").equals("0")){
                            assignment_layout.setVisibility(View.GONE);
                        }else{
                            assignment_layout.setVisibility(View.VISIBLE);
                            courseassignment.setText(getApplicationContext().getString(R.string.assignment)+" "+dataArray.getString("assignment_count"));
                        }
                        if(dataArray.getString("exam_count").equals("0")){
                            exam_layout.setVisibility(View.GONE);
                        }else{
                            exam_layout.setVisibility(View.VISIBLE);
                            courseexam.setText(getApplicationContext().getString(R.string.exams)+" "+dataArray.getString("exam_count"));
                        }
