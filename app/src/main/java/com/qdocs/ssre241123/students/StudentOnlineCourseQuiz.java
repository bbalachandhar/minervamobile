                ...
                if (result != null) {
                    ...
                    try {
                       ...
                       // name.setText(dataObject.getString("exam"));
                        ...
                        RelativeLayout headerLay = dialog.findViewById(R.id.addTask_dialog_header);
                        final TextView title = dialog.findViewById(R.id.title);
                        final TextView question_count = dialog.findViewById(R.id.question_count);
                        final TextView startBtn = dialog.findViewById(R.id.startBtn);
